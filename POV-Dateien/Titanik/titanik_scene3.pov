...
fog{ fog_type   2
     ...
     fog_offset 0.1
     fog_alt    2.0
     turbulence 0.8+0.4*clock*Nebel_Geschwindigkeit
   }
// ground ------------------------------------------------------------------
...
height_field{
   ...
   //smooth
    ...
    rotate <0,45,0>
    translate<0,0,10>
    translate <0, 0, -10-Schiff_Geschwindigkeit*clock>
...
#ifndef (Left_Upper_Arm_Rotate)         #declare Left_Upper_Arm_Rotate = <5,0,0>; 				 #end
...
#ifndef (Right_Upper_Arm_Rotate)        #declare Right_Upper_Arm_Rotate = <-15,0,0>; 			 #end
...
#declare Left_Upper_Arm_Rotate = <5,0,90*(clock-0.5)*2>; 			
#declare Right_Upper_Arm_Rotate = <-15,0,-90*(clock-0.5)*2>; 			 
